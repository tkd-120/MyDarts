...
const INPUT_MODES = { DARTBOARD: 'dartboard', BUTTONS: 'buttons' }
const GAME_MODES = {
  COUNT_UP: 'COUNT_UP',
...
const inputMode = ref(INPUT_MODES.DARTBOARD)
    ...
    <section v-else-if="isPlaying" class="panel">
      ...
      <div class="controls">
        <div class="control-row wrap">
          <p class="label">入力方法</p>
          <div class="pill-group">
            <button
              type="button"
              class="pill"
              :class="{ active: inputMode === INPUT_MODES.DARTBOARD }"
              @click="inputMode = INPUT_MODES.DARTBOARD"
            >
              DARTBOARD
            </button>
            <button
              type="button"
              class="pill"
              :class="{ active: inputMode === INPUT_MODES.BUTTONS }"
              @click="inputMode = INPUT_MODES.BUTTONS"
            >
              ボタン
            </button>
          </div>
        ...
        <div v-if="inputMode === INPUT_MODES.DARTBOARD" class="dartboard-area">
          <DartboardInput :disabled="isInputDisabled" @hit="onHit" />
          <p class="hint">ボードをタップして入力できます（MISS は外周タップ）</p>
        </div>
