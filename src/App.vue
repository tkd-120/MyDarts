...
function undoThrow() {
  ...
  inputMode.value = last.inputMode || inputMode.value
}
  ...
  <div class="app-shell">
    ...
    <section v-else-if="isPlaying" class="panel">
      ...
      <div class="controls">
          ...
          <div class="control-row">
            ...
            <div class="pill-group">
              <button
                type="button"
                class="pill"
                :class="{ active: inputMode === 'buttons' }"
                @click="inputMode = 'buttons'"
              >
                ボタン
              </button>
              <button
                type="button"
                class="pill"
                :class="{ active: inputMode === 'board' }"
                @click="inputMode = 'board'"
              >
                ダーツ盤
              </button>
            </div>
        ...
        <div v-if="inputMode === 'board'" class="dartboard-area">
